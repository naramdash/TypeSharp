...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor UnsupportedExportForwarding = new(
        ...
        "Export specifier declarations can describe local public surface or forward public surface across files. The current compiler supports unaliased local export lists, local named function export aliases, local literal export aliases, local top-level value export aliases, explicitly annotated function-valued top-level let exports and aliases, unannotated lambda-valued top-level let exports and aliases with conservative delegate inference, local type export aliases, relative named function and top-level value re-exports, relative type-only re-exports, and relative star re-exports over the lowerable source module surface. Non-relative forwarding and unsupported non-lowerable forwarding are not lowered yet.",
        "Use direct export modifiers, unaliased local export lists, local function aliases, local literal aliases, local top-level value aliases, function-valued let exports or aliases, local type aliases, relative named function or top-level value re-exports, relative type-only re-exports, or relative star re-exports; remove unsupported export specifier forms from build inputs until they are implemented.");
    ...
    public static readonly DiagnosticDescriptor UnsupportedTypeSharpMember = new(
        ...
        DiagnosticCategory.TypeChecking,
        "Unsupported TypeSharp class or interface member.",
        "The 1.0 TypeSharp-authored class/interface member subset is intentionally limited to lowerable public instance methods, typed class/interface events, and interface method signatures.",
        "Use a supported method or class/interface event shape, move data to a record, use imported C# constructors/events, or wait for the specific class/interface member form to be promoted.");
