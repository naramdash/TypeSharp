...
| `docs/tasks/0001-0252-task-ledger-rollup.md` | Compressed completed-work ledger including tasks `0251-docs-site-canonical-language-ledger` and `0252-agent-bootstrap-docs-site-canonical-followup`. |
