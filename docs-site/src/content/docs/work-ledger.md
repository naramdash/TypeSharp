...
This page is the web-facing view of the long-running task ledger. The compact source record lives in `docs/tasks/README.md` and `docs/tasks/0001-0252-task-ledger-rollup.md`.
...
| Current migration slice | Tasks `0251-docs-site-canonical-language-ledger` and `0252-agent-bootstrap-docs-site-canonical-followup` are complete and folded into the compressed task rollup. docs-site is the canonical standard language/project ledger surface; `docs/` is the temporary agentic work surface. |
| Completed work covered | 0001-0252 |
| Canonical task index | [`docs/tasks/README.md`](https://github.com/naramdash/TypeSharp/blob/main/docs/tasks/README.md) |
| Compressed work ledger | [`docs/tasks/0001-0252-task-ledger-rollup.md`](https://github.com/naramdash/TypeSharp/blob/main/docs/tasks/0001-0252-task-ledger-rollup.md) |
...
| CLI and VS Code | `check`, `build`, `run`, `format`, `new`, common options, warning gates, target/configuration/verbosity handling, strict option parsing, VS Code activation, LSP diagnostics, hover, definition, completion, and formatting. |
