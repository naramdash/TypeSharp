...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0427-imported-csharp-null-conditional-bitwise-compound-assignment-indexer-targets.md](0427-imported-csharp-null-conditional-bitwise-compound-assignment-indexer-targets.md) |
| Active summary     | Implement imported C# null-conditional bitwise compound assignment indexer targets.                               |
| Completed range    | 0001-0400, 0402-0426                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0426 roadmap refresh after imported C# null-conditional bitwise compound assignment member targets | 0427 Imported C# null-conditional bitwise compound assignment indexer targets | [0427-imported-csharp-null-conditional-bitwise-compound-assignment-indexer-targets.md](0427-imported-csharp-null-conditional-bitwise-compound-assignment-indexer-targets.md) | Implement `receiver?[index] |= value`, `receiver?[index] &= value`, and `receiver?[index] ^= value` for readable/writable metadata-backed imported C# instance indexers with supported arguments, reusing the existing primitive integral/enum/bool bitwise compound policy, preserving single receiver/index evaluation, skipping index/right-side evaluation on null receivers, and lowering through C# 7.3-compatible guards/operator forms. |
| Q1       | Done        | Task 0425 imported C# null-conditional bitwise compound assignment member targets | 0426 Roadmap refresh after imported C# null-conditional bitwise compound assignment member targets | [tasks-rollup.md#task-0426-roadmap-refresh-after-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets](tasks-rollup.md#task-0426-roadmap-refresh-after-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets) | Rechecked official language/platform/package/test/editor/CI signals, confirmed generated package-free `net48`/C# 7.3 and existing `net10.0` `MSTest.Sdk/4.2.3`/MTP package-shard baselines, kept Task 0401 blocked, answered that NuGet is already used at the test-host boundary, and selected imported C# null-conditional bitwise compound assignment indexer targets as Task 0427. |
