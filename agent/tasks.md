...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0421-imported-csharp-null-conditional-logical-unsigned-shift-assignment-member-targets.md](0421-imported-csharp-null-conditional-logical-unsigned-shift-assignment-member-targets.md) |
| Active summary     | Implement imported C# null-conditional logical unsigned shift assignment member targets.                                            |
| Completed range    | 0001-0400, 0402-0420                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0420 roadmap refresh after imported C# null-conditional indexer reads | 0421 Imported C# null-conditional logical unsigned shift assignment member targets | [0421-imported-csharp-null-conditional-logical-unsigned-shift-assignment-member-targets.md](0421-imported-csharp-null-conditional-logical-unsigned-shift-assignment-member-targets.md) | Implement `receiver?.Member >>>= count` for readable/writable metadata-backed imported C# instance field/property targets using existing `>>>=` primitive/count policy, single receiver evaluation, skipped count evaluation on null receivers, and C# 7.3-compatible guard/cast lowering; leave indexers, other compound operators, events, static/local/TypeSharp-owned targets, and user-defined operators out of scope. |
