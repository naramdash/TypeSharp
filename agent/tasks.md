...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0473-imported-csharp-null-conditional-member-user-defined-multiplicative-operator-policy.md](0473-imported-csharp-null-conditional-member-user-defined-multiplicative-operator-policy.md) |
| Active summary     | Extend imported C# user-defined multiplicative operator assignment to null-conditional field/property member targets. |
| Completed range    | 0001-0472                                                                             |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | Ready       | Task 0472 roadmap refresh after imported C# regular indexer user-defined multiplicative operator policy | 0473 Imported C# null-conditional member user-defined multiplicative operator policy | [0473-imported-csharp-null-conditional-member-user-defined-multiplicative-operator-policy.md](0473-imported-csharp-null-conditional-member-user-defined-multiplicative-operator-policy.md) | Extend the selected imported static binary multiplicative operator precursor to null-conditional imported C# readable/writable field/property member `*=`, `/=`, and `%=` targets while preserving skipped right-side evaluation, C# 7.3 guard lowering, generated package-free `net48`, deterministic diagnostics, and current 574/578 baselines unless coverage intentionally raises them. |
