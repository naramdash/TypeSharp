...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0415-extension-property-null-conditional-access-diagnostics.md](0415-extension-property-null-conditional-access-diagnostics.md) |
| Active summary     | Add extension-property-specific diagnostics for null-conditional access and assignment targets.                           |
| Completed range    | 0001-0400, 0402-0414                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0414 roadmap refresh after extension property nullable receiver access diagnostics | 0415 Extension property null-conditional access diagnostics | [0415-extension-property-null-conditional-access-diagnostics.md](0415-extension-property-null-conditional-access-diagnostics.md) | Add deterministic `TS2201` diagnostics when `?.` read or simple assignment targets resolve to getter-only TypeSharp-authored extension properties before nullable receiver lifting or TypeSharp-owned null-conditional lowering expands the surface. |
