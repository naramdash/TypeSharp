...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0394-logical-unsigned-shift-assignment-imported-member-targets.md](0394-logical-unsigned-shift-assignment-imported-member-targets.md) |
| Active summary     | 0394 Logical unsigned shift assignment imported member targets                         |
| Completed range    | 0001-0393                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0393 roadmap refresh after logical unsigned shift assignment expressions | 0394 Logical unsigned shift assignment imported member targets       | [0394-logical-unsigned-shift-assignment-imported-member-targets.md](0394-logical-unsigned-shift-assignment-imported-member-targets.md)                                                     | Implement bounded imported C# member `>>>=` targets with C# 7.3-compatible explicit assignment/cast lowering and a single-evaluation receiver policy.                                           |
