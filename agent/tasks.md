...
- [ ] Task 수행 및 프로젝트 코드들 병렬로 수행할 수 있는 구간을 찾아 최적화하기
- [ ] docs package.json deps 최신화하기
- [ ] docs 에 쓰이는 javascript는 최대한 typescript로 바꾸기, typescript로 바꿀 수 없는 부분은 명확하게 주석으로 설명하기
...
| -------- | ------ | -------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Q0       | Done   | User directive | Codex skills configuration  | [tasks-rollup.md#task-0258-codex-skills-configuration](tasks-rollup.md#task-0258-codex-skills-configuration)   | Installed project-useful Codex skills and documented selection, install status, and trigger policy in `agent/codex-skills.md`.            |
