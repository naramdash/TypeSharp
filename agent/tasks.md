...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | Ready       | Task 0398 null-conditional assignment imported member targets | 0399 Roadmap refresh after null-conditional assignment imported member targets       | TBD                                                                                                                                                                        | Recheck official language/platform/package/test/editor/CI signals after the bounded `receiver?.Member = value` slice landed, reaffirm or update the `net48`/C# 7.3/package/test-host baseline, and select the next bounded implementation slice.                                           |
