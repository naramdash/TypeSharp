...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0425-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets.md](0425-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets.md) |
| Active summary     | Implement imported C# null-conditional bitwise compound assignment member targets.                               |
| Completed range    | 0001-0400, 0402-0424                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0424 roadmap refresh after imported C# null-conditional logical unsigned shift assignment indexer targets | 0425 Imported C# null-conditional bitwise compound assignment member targets | [0425-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets.md](0425-imported-csharp-null-conditional-bitwise-compound-assignment-member-targets.md) | Implement `receiver?.Member |= value`, `receiver?.Member &= value`, and `receiver?.Member ^= value` for readable/writable metadata-backed imported C# instance fields/properties using existing bitwise compound target/value policy, single receiver evaluation, skipped RHS evaluation on null receivers, and C# 7.3 guard/operator lowering. |
