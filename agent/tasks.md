...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0419-imported-csharp-null-conditional-indexer-read-expressions.md](0419-imported-csharp-null-conditional-indexer-read-expressions.md) |
| Active summary     | Implement imported C# null-conditional indexer read expressions.                                            |
| Completed range    | 0001-0400, 0402-0418                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0418 roadmap refresh after imported C# null-conditional member reads | 0419 Imported C# null-conditional indexer read expressions | [0419-imported-csharp-null-conditional-indexer-read-expressions.md](0419-imported-csharp-null-conditional-indexer-read-expressions.md) | Implement `receiver?[index]` reads for readable metadata-backed imported C# instance indexers with nullable-compatible result typing and C# 7.3-compatible single-evaluation lowering. |
...
| Q1       | Done        | Task 0415 extension property null-conditional access diagnostics | 0416 Roadmap refresh after extension property null-conditional access diagnostics | [tasks-rollup.md#task-0416-roadmap-refresh-after-extension-property-null-conditional-access-diagnostics](tasks-rollup.md#task-0416-roadmap-refresh-after-extension-property-null-conditional-access-diagnostics) | Rechecked official language/platform/package/test/editor/CI signals; reaffirmed package-free `net48`/C# 7.3 and existing `net10.0` MSTest.Sdk/MTP bridge plus shards; kept Task 0401 blocked; selected imported C# null-conditional member reads next. |
