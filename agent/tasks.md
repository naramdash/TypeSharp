...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0424-roadmap-refresh-after-imported-csharp-null-conditional-logical-unsigned-shift-assignment-indexer-targets.md](0424-roadmap-refresh-after-imported-csharp-null-conditional-logical-unsigned-shift-assignment-indexer-targets.md) |
| Active summary     | Refresh roadmap after imported C# null-conditional logical unsigned shift assignment indexer targets.                               |
| Completed range    | 0001-0400, 0402-0423                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0423 imported C# null-conditional logical unsigned shift assignment indexer targets | 0424 Roadmap refresh after imported C# null-conditional logical unsigned shift assignment indexer targets | [0424-roadmap-refresh-after-imported-csharp-null-conditional-logical-unsigned-shift-assignment-indexer-targets.md](0424-roadmap-refresh-after-imported-csharp-null-conditional-logical-unsigned-shift-assignment-indexer-targets.md) | Recheck official language/platform/package/test/editor/CI signals after `receiver?[index] >>>= count`, confirm generated `net48`/C# 7.3 and `net10.0` MSTest.Sdk/MTP package-shard baselines, keep Task 0401 blocked unless explicit approval arrives, and select the next bounded slice. |
