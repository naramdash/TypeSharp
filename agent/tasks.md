...
| Active summary     | None                                                                                                                     |
| Completed range    | 0001-0400, 0402-0404                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | Ready       | Task 0404 roadmap refresh after C# 14-inspired extension property slice | 0405 Extension property duplicate and conflict diagnostics       | TBD                                                                                                                                                                        | Define and implement deterministic diagnostics for duplicate TypeSharp-authored extension properties and conflicts around the current exact receiver matching/instance/structural precedence before static extension members, setters, operators, nullable receiver lifting, or imported extension property metadata are added.                                           |
