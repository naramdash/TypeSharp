...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0447-local-floating-decimal-multiplicative-compound-assignment-policy.md](0447-local-floating-decimal-multiplicative-compound-assignment-policy.md) |
| Active summary     | Extend local multiplicative compound assignment to a bounded floating-point and decimal policy. |
| Completed range    | 0001-0400, 0402-0446                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0446 roadmap refresh after imported C# null-conditional indexer multiplicative compound assignment targets | 0447 Local floating-point and decimal multiplicative compound assignment policy | [0447-local-floating-decimal-multiplicative-compound-assignment-policy.md](0447-local-floating-decimal-multiplicative-compound-assignment-policy.md) | Extend local mutable `*=`, `/=`, and `%=` from primitive integral-only operands to a bounded known non-null `float`, `double`, and `decimal` policy; preserve generated package-free `net48`/C# 7.3 output; add focused positive/negative/generated C# consumer coverage; keep imported, null-conditional, checked-overflow, and user-defined operator expansion out of scope. |
