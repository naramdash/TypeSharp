...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0439-imported-csharp-member-multiplicative-compound-assignment-targets.md](0439-imported-csharp-member-multiplicative-compound-assignment-targets.md) |
| Active summary     | Implement imported C# member multiplicative compound assignment targets. |
| Completed range    | 0001-0400, 0402-0438                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0438 roadmap refresh after local multiplicative compound assignment expressions | 0439 Imported C# member multiplicative compound assignment targets | [0439-imported-csharp-member-multiplicative-compound-assignment-targets.md](0439-imported-csharp-member-multiplicative-compound-assignment-targets.md) | Implement `receiver.Member *= value`, `receiver.Member /= value`, and `receiver.Member %= value` for readable/writable metadata-backed imported C# instance/static field/property targets using the local primitive integral multiplicative assign-back policy, preserving single receiver evaluation, generated package-free `net48`/C# 7.3 artifacts, deterministic diagnostics, and existing test-host package boundaries. |
