...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0437-local-multiplicative-compound-assignment-expressions.md](0437-local-multiplicative-compound-assignment-expressions.md) |
| Active summary     | Implement local multiplicative compound assignment expressions for mutable primitive integral numeric bindings. |
| Completed range    | 0001-0400, 0402-0436                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0436 roadmap refresh after imported C# null-conditional shift compound assignment indexer targets | 0437 Local multiplicative compound assignment expressions | [0437-local-multiplicative-compound-assignment-expressions.md](0437-local-multiplicative-compound-assignment-expressions.md) | Implement local mutable `*=`, `/=`, and `%=` expressions over known non-null primitive integral numeric values, preserving `let mut` assignment checks, C# 7.3-compatible operator lowering, generated package-free `net48` artifacts, and existing test-host package boundaries. |
