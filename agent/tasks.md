...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0397-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-indexer-targets.md](0397-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-indexer-targets.md) |
| Active summary     | 0397 Roadmap refresh after logical unsigned shift assignment imported indexer targets                         |
| Completed range    | 0001-0396                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0396 logical unsigned shift assignment imported indexer targets | 0397 Roadmap refresh after logical unsigned shift assignment imported indexer targets       | [0397-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-indexer-targets.md](0397-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-indexer-targets.md)                                                     | Recheck official language/platform/package/test/editor/CI signals after imported C# indexer `>>>=`, confirm generated artifact and `net10.0` test-host NuGet package boundaries, and select the next bounded slice.                                           |
...
| Q1       | Done        | Task 0394 logical unsigned shift assignment imported member targets | 0395 Roadmap refresh after logical unsigned shift assignment imported member targets       | [tasks-rollup.md#task-0395-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-member-targets](tasks-rollup.md#task-0395-roadmap-refresh-after-logical-unsigned-shift-assignment-imported-member-targets)                                                     | Rechecked official language/platform/package/test/editor/CI signals, confirmed no generated-artifact or test-host package baseline change, and selected imported indexer `>>>=` lowering next.                                           |
