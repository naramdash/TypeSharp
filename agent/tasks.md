...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0413-extension-property-nullable-receiver-access-diagnostics.md](0413-extension-property-nullable-receiver-access-diagnostics.md) |
| Active summary     | Add deterministic diagnostics for nullable receiver access to getter-only extension properties.                           |
| Completed range    | 0001-0400, 0402-0412                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0412 roadmap refresh after extension property assignment diagnostics | 0413 Extension property nullable receiver access diagnostics | [0413-extension-property-nullable-receiver-access-diagnostics.md](0413-extension-property-nullable-receiver-access-diagnostics.md) | Add deterministic diagnostics when a nullable receiver expression accesses a getter-only TypeSharp-authored extension property whose implemented receiver match is currently exact non-null; keep nullable receiver lifting, setter syntax/lowering, static extension members, operators, imported extension property metadata, and richer ranking out of scope. |
| Q1       | Done        | Task 0411 extension property assignment diagnostics | 0412 Roadmap refresh after extension property assignment diagnostics | [tasks-rollup.md#task-0412-roadmap-refresh-after-extension-property-assignment-diagnostics](tasks-rollup.md#task-0412-roadmap-refresh-after-extension-property-assignment-diagnostics) | Rechecked official language/platform/package/test/editor/CI signals; reaffirmed generated package-free `net48`/C# 7.3 and the existing `net10.0` `MSTest.Sdk/4.2.3`/MTP NuGet package bridge plus shards; kept Task 0401 blocked; selected nullable receiver access diagnostics next. |
| Q1       | Done        | Task 0410 roadmap refresh after extension property nullable receiver diagnostics | 0411 Extension property assignment diagnostics | [tasks-rollup.md#task-0411-extension-property-assignment-diagnostics](tasks-rollup.md#task-0411-extension-property-assignment-diagnostics) | Added deterministic `TS2201` diagnostics for ordinary, bitwise compound, shift compound, and logical unsigned shift assignment targets that resolve to getter-only TypeSharp-authored extension properties; preserved read/helper lowering behavior; shared catalog count remains 536. |
