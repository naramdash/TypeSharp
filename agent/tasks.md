...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0384-generic-optional-default-parameters.md](0384-generic-optional-default-parameters.md) |
| Active summary     | 0384 Generic TypeSharp optional/default parameters                         |
| Completed range    | 0001-0383                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0383 roadmap refresh        | 0384 Generic TypeSharp optional/default parameters             | [0384-generic-optional-default-parameters.md](0384-generic-optional-default-parameters.md)                                                                                   | Extend trailing literal defaults to bounded TypeSharp-owned generic direct functions while preserving generated `net48` C# 7.3 optional metadata.                                          |
