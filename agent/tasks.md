...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0396-logical-unsigned-shift-assignment-imported-indexer-targets.md](0396-logical-unsigned-shift-assignment-imported-indexer-targets.md) |
| Active summary     | 0396 Logical unsigned shift assignment imported indexer targets                         |
| Completed range    | 0001-0395                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0395 roadmap refresh after logical unsigned shift assignment imported member targets | 0396 Logical unsigned shift assignment imported indexer targets       | [0396-logical-unsigned-shift-assignment-imported-indexer-targets.md](0396-logical-unsigned-shift-assignment-imported-indexer-targets.md)                                                     | Implement bounded metadata-backed imported C# indexer `>>>=` targets with C# 7.3-compatible explicit assignment/cast lowering and single-evaluation receiver/index-argument policy.                                           |
