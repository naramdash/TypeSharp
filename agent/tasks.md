...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0398-null-conditional-assignment-imported-member-targets.md](0398-null-conditional-assignment-imported-member-targets.md) |
| Active summary     | 0398 Null-conditional assignment imported member targets                         |
| Completed range    | 0001-0397                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0397 roadmap refresh after logical unsigned shift assignment imported indexer targets | 0398 Null-conditional assignment imported member targets       | [0398-null-conditional-assignment-imported-member-targets.md](0398-null-conditional-assignment-imported-member-targets.md)                                                     | Implement the first C# 14-inspired `?.` assignment slice: token/parser/syntax plus C# 7.3-compatible lowering for metadata-backed imported instance field/property `receiver?.Member = value`; keep indexers, compound assignment, events, and generated packages out.                                           |
