...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0377-roadmap-refresh-after-optional-default-parameters.md](0377-roadmap-refresh-after-optional-default-parameters.md) |
| Active summary     | 0377 Roadmap refresh after optional/default parameters                                              |
| Completed range    | 0001-0376                                                                                          |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0376 optional/default params | 0377 Roadmap refresh after optional/default parameters         | [0377-roadmap-refresh-after-optional-default-parameters.md](0377-roadmap-refresh-after-optional-default-parameters.md)                                                        | Recheck official C#/F#/TypeScript/.NET/NuGet/test/tooling signals after the optional/default parameter slice and select the next bounded candidate.                                      |
| Q2       | Done        | Task 0375 roadmap refresh        | 0376 Optional/default parameter declarations                  | [tasks-rollup.md#task-0376-optional-default-parameter-declaration-slice](tasks-rollup.md#task-0376-optional-default-parameter-declaration-slice)                              | Added trailing literal defaults for non-generic TypeSharp-owned direct `fun` declarations with parser/checker/backend/docs and generated `net48` C# consumer evidence.                  |
| Q1       | Done        | Task 0374 CI regression gate     | 0375 Roadmap refresh after CI regression gate                  | [tasks-rollup.md#task-0375-roadmap-refresh-after-ci-regression-gate](tasks-rollup.md#task-0375-roadmap-refresh-after-ci-regression-gate)                                     | Rechecked official signals after the Windows regression gate, confirmed no baseline change, and selected optional/default parameter declarations next.                                     |
