...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0373-roadmap-refresh-after-test-host-nuget-hardening.md](0373-roadmap-refresh-after-test-host-nuget-hardening.md) |
| Active summary     | 0373 Roadmap refresh after test-host NuGet hardening                                                  |
| Completed range    | 0001-0372                                                                                             |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0372 restore hardening      | 0373 Roadmap refresh after test-host NuGet hardening           | [0373-roadmap-refresh-after-test-host-nuget-hardening.md](0373-roadmap-refresh-after-test-host-nuget-hardening.md)                                                           | Recheck roadmap after hardening the selected MSTest SDK/MTP package path and choose the next bounded TypeSharp task.                                                                      |
...
| Q4       | Done        | Task 0369 roadmap refresh        | 0370 Test catalog extraction and MSTest bridge                  | [tasks-rollup.md#task-0370-test-catalog-extraction-and-mstest-bridge](tasks-rollup.md#task-0370-test-catalog-extraction-and-mstest-bridge)                                   | Extracted `TypeSharpCompilerTestCases.All`, kept main/shard runners on the same catalog, and added a pinned `MSTest.Sdk/4.2.3` `dotnet test` bridge.                                    |
