...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0374-ci-regression-gate-for-shard-and-mstest-smoke.md](0374-ci-regression-gate-for-shard-and-mstest-smoke.md) |
| Active summary     | 0374 CI regression gate for shard runner and MSTest smoke                                       |
| Completed range    | 0001-0373                                                                                       |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0373 roadmap refresh        | 0374 CI regression gate for shard runner and MSTest smoke      | [0374-ci-regression-gate-for-shard-and-mstest-smoke.md](0374-ci-regression-gate-for-shard-and-mstest-smoke.md)                                                               | Add a Windows GitHub Actions regression gate for the package-free shard runner plus hardened MSTest smoke path.                                                                            |
