...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0382-mstest-package-shard-bridge.md](0382-mstest-package-shard-bridge.md) |
| Active summary     | 0382 MSTest package shard bridge                                          |
| Completed range    | 0001-0381                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0381 roadmap refresh        | 0382 MSTest package shard bridge                              | [0382-mstest-package-shard-bridge.md](0382-mstest-package-shard-bridge.md)                                                                                                   | Add package-runner shard projects over the existing catalog so `MSTest.Sdk`/MTP can run the full catalog in parallel without replacing the faster package-free runner.                    |
