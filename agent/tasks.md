...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0409-extension-property-nullable-receiver-diagnostics.md](0409-extension-property-nullable-receiver-diagnostics.md) |
| Active summary     | Add diagnostics for unsupported nullable extension-property receivers.                           |
| Completed range    | 0001-0400, 0402-0408                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0408 roadmap refresh after extension property helper name collision diagnostics | 0409 Extension property nullable receiver diagnostics | [0409-extension-property-nullable-receiver-diagnostics.md](0409-extension-property-nullable-receiver-diagnostics.md) | Add deterministic `TS2201` diagnostics for getter-only TypeSharp-authored extension properties declared on nullable receivers, preserving the current exact known non-null receiver policy until nullable receiver lifting is designed. |
