...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0383-roadmap-refresh-after-mstest-package-shards.md](0383-roadmap-refresh-after-mstest-package-shards.md) |
| Active summary     | 0383 Roadmap refresh after MSTest package shards                            |
| Completed range    | 0001-0382                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0382 MSTest package shards  | 0383 Roadmap refresh after MSTest package shards              | [0383-roadmap-refresh-after-mstest-package-shards.md](0383-roadmap-refresh-after-mstest-package-shards.md)                                                                   | Recheck official signals after package-based MSTest sharding, confirm baseline, and select the next bounded slice.                                                                         |
