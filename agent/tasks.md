...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0372-test-host-nuget-restore-hardening.md](0372-test-host-nuget-restore-hardening.md) |
| Active summary     | 0372 Test-host NuGet package selection and restore hardening                           |
| Completed range    | 0001-0371                                                                              |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0371 roadmap refresh        | 0372 Test-host NuGet package selection and restore hardening   | [0372-test-host-nuget-restore-hardening.md](0372-test-host-nuget-restore-hardening.md)                                                                                       | Compare MSTest SDK/MTP and xUnit.net v3 over the extracted catalog, then harden restore controls for the selected test-host NuGet path.                                                  |
