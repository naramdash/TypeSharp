...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0451-imported-csharp-indexer-floating-decimal-multiplicative-compound-assignment-policy.md](0451-imported-csharp-indexer-floating-decimal-multiplicative-compound-assignment-policy.md) |
| Active summary     | Extend imported C# regular indexer multiplicative compound assignment to bounded floating-point and decimal operands. |
| Completed range    | 0001-0400, 0402-0450                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0450 roadmap refresh after imported C# regular member floating-point and decimal multiplicative compound assignment policy | 0451 Imported C# regular indexer floating-point and decimal multiplicative compound assignment policy | [0451-imported-csharp-indexer-floating-decimal-multiplicative-compound-assignment-policy.md](0451-imported-csharp-indexer-floating-decimal-multiplicative-compound-assignment-policy.md) | Extend imported C# instance indexer `receiver[index] *= value`, `receiver[index] /= value`, and `receiver[index] %= value` targets with selected public getter/setter pairs and supported arguments to bounded known non-null integral/floating-point/decimal operands, reusing local/member assign-back, preserving generated package-free `net48`/C# 7.3 and single receiver/index evaluation; keep null-conditional, checked-overflow, user-defined operators, and Task 0401 out of scope. |
