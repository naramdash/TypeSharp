...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0393-roadmap-refresh-after-logical-unsigned-shift-assignment-expressions.md](0393-roadmap-refresh-after-logical-unsigned-shift-assignment-expressions.md) |
| Active summary     | 0393 Roadmap refresh after logical unsigned shift assignment expressions                         |
| Completed range    | 0001-0392                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0392 logical unsigned shift assignment expressions | 0393 Roadmap refresh after logical unsigned shift assignment expressions       | [0393-roadmap-refresh-after-logical-unsigned-shift-assignment-expressions.md](0393-roadmap-refresh-after-logical-unsigned-shift-assignment-expressions.md)                                                     | Recheck official signals after bounded local `>>>=`, confirm the generated `net48`/C# 7.3 baseline, and select the next bounded implementation slice.                                           |
