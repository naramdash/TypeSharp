...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0417-imported-csharp-null-conditional-member-read-expressions.md](0417-imported-csharp-null-conditional-member-read-expressions.md) |
| Active summary     | Implement imported C# null-conditional member read expressions.                                            |
| Completed range    | 0001-0400, 0402-0416                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0416 roadmap refresh after extension property null-conditional access diagnostics | 0417 Imported C# null-conditional member read expressions | [0417-imported-csharp-null-conditional-member-read-expressions.md](0417-imported-csharp-null-conditional-member-read-expressions.md) | Implement `receiver?.Member` reads for readable metadata-backed imported C# instance fields/properties with deterministic type checking and C# 7.3-compatible lowering; preserve extension-property-specific diagnostics and existing assignment behavior; keep indexer reads/invocation/chains/compound/static/event/local/TypeSharp-owned targets out of scope. |
