...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0455-imported-csharp-null-conditional-indexer-floating-decimal-multiplicative-compound-assignment-policy.md](0455-imported-csharp-null-conditional-indexer-floating-decimal-multiplicative-compound-assignment-policy.md) |
| Active summary     | Extend imported C# null-conditional indexer multiplicative compound assignment to bounded floating-point and decimal operands. |
| Completed range    | 0001-0400, 0402-0454                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0454 roadmap refresh after imported C# null-conditional member floating-point and decimal multiplicative compound assignment policy | 0455 Imported C# null-conditional indexer floating-point and decimal multiplicative compound assignment policy | [0455-imported-csharp-null-conditional-indexer-floating-decimal-multiplicative-compound-assignment-policy.md](0455-imported-csharp-null-conditional-indexer-floating-decimal-multiplicative-compound-assignment-policy.md) | Extend imported C# `receiver?[index] *= value`, `receiver?[index] /= value`, and `receiver?[index] %= value` targets to bounded integral/floating-point/decimal operands on selected metadata-backed getter/setter indexers with supported index arguments; preserve skipped index/right-side evaluation on null receivers, C# 7.3 guard lowering, generated package-free `net48`, and current package baselines. |
