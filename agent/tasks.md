...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0376-optional-default-parameter-declarations.md](0376-optional-default-parameter-declarations.md) |
| Active summary     | 0376 Optional/default parameter declarations                                                       |
| Completed range    | 0001-0375                                                                                          |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0375 roadmap refresh        | 0376 Optional/default parameter declarations                  | [0376-optional-default-parameter-declarations.md](0376-optional-default-parameter-declarations.md)                                                                            | Implement a bounded TypeSharp-owned optional/default parameter declaration slice for direct functions.                                                                                    |
