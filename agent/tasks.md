...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0429-imported-csharp-null-conditional-additive-compound-assignment-member-targets.md](0429-imported-csharp-null-conditional-additive-compound-assignment-member-targets.md) |
| Active summary     | Implement imported C# null-conditional additive compound assignment member targets.                               |
| Completed range    | 0001-0400, 0402-0428                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | In Progress | Task 0428 roadmap refresh after imported C# null-conditional bitwise compound assignment indexer targets | 0429 Imported C# null-conditional additive compound assignment member targets | [0429-imported-csharp-null-conditional-additive-compound-assignment-member-targets.md](0429-imported-csharp-null-conditional-additive-compound-assignment-member-targets.md) | Implement `receiver?.Member += value` and `receiver?.Member -= value` for readable/writable metadata-backed imported C# instance fields/properties with supported primitive numeric operands, preserving single receiver evaluation, skipped RHS evaluation on null receivers, generated package-free `net48`/C# 7.3 lowering, and the existing `net10.0` MSTest.Sdk/MTP package-shard boundary. |
