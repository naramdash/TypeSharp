...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0392-logical-unsigned-shift-assignment-expressions.md](0392-logical-unsigned-shift-assignment-expressions.md) |
| Active summary     | 0392 Logical unsigned shift assignment expressions                         |
| Completed range    | 0001-0391                                                                         |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q2       | In Progress | Task 0391 roadmap refresh after logical unsigned shift expressions | 0392 Logical unsigned shift assignment expressions       | [0392-logical-unsigned-shift-assignment-expressions.md](0392-logical-unsigned-shift-assignment-expressions.md)                                                     | Implement bounded `>>>=` assignment over supported primitive integral mutation surfaces with C# 7.3-compatible explicit assignment/cast lowering.                                           |
