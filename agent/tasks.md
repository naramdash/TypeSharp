...
| Active summary     | None                                                                                                                     |
| Completed range    | 0001-0400, 0402-0406                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | Ready       | Task 0406 roadmap refresh after extension property duplicate/conflict diagnostics | 0407 Extension property helper name collision diagnostics | TBD | Detect and diagnose TypeSharp-authored extension property helper-name collisions before backend emission; getter-only properties lower to `GetName(this T receiver)` helpers and must not collide with TypeSharp-authored extension methods or generated helpers in the same extension container. |
...
| Q1       | Done        | Task 0403 C# 14 extension member policy and bounded implementation slice | 0404 Roadmap refresh after C# 14-inspired extension property slice       | [tasks-rollup.md#task-0404-roadmap-refresh-after-c-14-inspired-extension-property-slice](tasks-rollup.md#task-0404-roadmap-refresh-after-c-14-inspired-extension-property-slice) | Rechecked official language/platform/package/test/editor/CI signals after getter-only TypeSharp-authored extension properties landed, confirmed no generated `net48`/C# 7.3 or test-host package baseline change, reaffirmed the existing `net10.0` `MSTest.Sdk/4.2.3`/MTP NuGet bridge and shards, left Task 0401 blocked pending CI-fix approval, and selected extension-property duplicate/conflict diagnostics next. |
