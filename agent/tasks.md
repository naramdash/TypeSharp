...
| Field              | Value                                                                                                                    |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Active task packet | [0471-imported-csharp-regular-indexer-user-defined-multiplicative-operator-policy.md](0471-imported-csharp-regular-indexer-user-defined-multiplicative-operator-policy.md) |
| Active summary     | Extend the imported C# static binary user-defined multiplicative operator precursor from mutable locals and regular members to regular imported C# indexer assignment targets. |
| Completed range    | 0001-0400, 0402-0470                                                                  |
...
| -------- | ----------- | -------------------------------- | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Q1       | Ready       | Task 0470 roadmap refresh after imported C# regular member user-defined multiplicative operator policy | 0471 Imported C# regular indexer user-defined multiplicative operator policy | [0471-imported-csharp-regular-indexer-user-defined-multiplicative-operator-policy.md](0471-imported-csharp-regular-indexer-user-defined-multiplicative-operator-policy.md) | Extend the imported static binary multiplicative operator precursor from mutable locals and regular field/property members to regular imported C# readable/writable indexer `*=`, `/=`, and `%=` targets while preserving primitive indexer behavior, generated package-free `net48`, C# 7.3 lowering, deterministic diagnostics, and Task 0401's blocked status. |
