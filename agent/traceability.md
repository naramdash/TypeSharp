...
| Realistic runnable tysh examples | [tasks-rollup.md#task-0268-realistic-runnable-tysh-examples](tasks-rollup.md#task-0268-realistic-runnable-tysh-examples), `examples/runnable`, [Examples](../docs/src/content/docs/examples.md), [Tutorials](../docs/src/content/docs/tutorials.md), `tests/TypeSharp.Compiler.Tests/Program.cs` |
| Runnable example code explanations | [tasks-rollup.md#task-0269-runnable-example-code-explanations](tasks-rollup.md#task-0269-runnable-example-code-explanations), `examples/runnable/*/README.md`, [Examples](../docs/src/content/docs/examples.md), [Writing Guide](../docs/src/content/docs/writing-guide.md), `tests/TypeSharp.Compiler.Tests/Program.cs` |
