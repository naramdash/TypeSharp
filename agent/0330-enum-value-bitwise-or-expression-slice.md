# Task: enum-value-bitwise-or-expression-slice

Status: In Progress
Queue: Q2
Start Time: 2026-05-21 15:58:05 +09:00
End Time: TBD

## Objective

Add bounded expression-level enum value bitwise OR for same-enum operands, lowering to C# `|`.
...
- Lower accepted expressions such as `Permission.Read | Permission.Write` to C# `|`.
...
- [ ] Parser accepts enum value `|` expressions without changing type-union parsing.
...
Done: 0329 roadmap refresh selected this slice.
