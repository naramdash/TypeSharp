...
dotnet test `
  ...
  --minimum-expected-tests 552 `
  --no-progress
```

The `552` package-shard expectation is the 548 shared catalog cases plus one `CatalogIsExposedForPackageRunners` smoke per shard.
