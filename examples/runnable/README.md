...
The smoke test `runnable example project commands are smoke-tested` copies this folder to `test/tmp`, then executes the commands above against the copied projects so generated `bin/`, `obj/`, and `generated/` artifacts do not dirty the repository.
