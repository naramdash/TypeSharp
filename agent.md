...
3. [docs/tasks/README.md](docs/tasks/README.md)
...
10. [docs-site Core Goal](docs-site/src/content/docs/goal.md)
11. [docs-site Grammar](docs-site/src/content/docs/grammar.md)
12. [Grammar And Language Reference](docs-site/src/content/docs/reference.md)
13. [docs-site Feature Status](docs-site/src/content/docs/feature-status.md)
14. 현재 작업과 직접 관련된 docs-site canonical 문서 또는 `docs/` temporary work 문서
...
4. 설계 또는 구현
   ...
   - 문법이 부족하면 [docs-site Grammar](docs-site/src/content/docs/grammar.md)와 [Grammar And Language Reference](docs-site/src/content/docs/reference.md)를 먼저 갱신하고, 아직 남은 `docs/grammar/` bridge file은 같은 변경에서 맞춘다.
...
1. [docs/tasks/README.md](docs/tasks/README.md)에 `In Progress` task packet이 있으면, 사용자 요청과 충돌하지 않는 한 그 작업을 먼저 이어간다.
...
4. task 0251 이후 docs-site는 표준 언어/프로젝트 원장의 canonical 표면이 되며, `docs/`는 agentic temporary work와 handoff 문서만 남기는 방향으로 줄인다. 구현 우선순위와 활성 작업 상태는 여전히 `docs/tasks/README.md`와 active task packet이 결정하고, docs-site Work Ledger는 그 상태를 웹에서 보여준다.
