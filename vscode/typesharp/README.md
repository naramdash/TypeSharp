...
Docs-site contract:
- `docs-site/src/content/docs/vscode-lsp.md` lists the same smoke-tested commands so the public VS Code/LSP documentation stays reproducible by the repository checks.
