...
Task: [0167 Official Docs Deep Benchmark And Docs Overhaul](tasks/0167-official-docs-deep-benchmark-docs-overhaul.md)
...
TypeSharp action: keep [Language Tour](../docs-site/src/content/docs/language-tour.md), [Fundamentals](../docs-site/src/content/docs/fundamentals.md), and formal reference pages separate. Surface stability, diagnostics, and generated artifact concerns from the first-level navigation.
...
TypeSharp action: keep background-based [Learning Paths](../docs-site/src/content/docs/learning-paths.md), then add deeper module and type-system pages so TypeScript users can find TypeSharp equivalents for modules, narrowing, structural types, and public boundary rules.
...
| Advanced implementer | Language specification, compiler behavior, versioning, and design notes are reachable after user docs. | `Advanced Topics`, canonical `docs/`, task packets, traceability, and tests must remain linked from the docs site. |
