...
이 문서는 TypeSharp 장기 작업 세션이 어떤 파일을 읽고, 어떻게 작업을 고르고, 어떤 상태를 남겨야 하는지만 정의한다. 목표와 표준 사양의 owner는 docs-site canonical pages다.
...
1. [../agent.md](../agent.md)
2. [Core Goal](../docs-site/src/content/docs/goal.md)
...
8. [Document Ownership](../docs-site/src/content/docs/document-ownership.md)
9. [Project Ledger](../docs-site/src/content/docs/project-ledger.md)
10. [Work Ledger](../docs-site/src/content/docs/work-ledger.md)
11. [Agentic Workflow](../docs-site/src/content/docs/agentic-workflow.md)
12. 작업과 직접 관련된 docs-site canonical page 또는 repo source
...
6. If the work is too large for one turn, create `docs/NNNN-short-name.md`, set it as the active task in [tasks.md](tasks.md), and mark its agent queue row `In Progress`.
...
Use this format for `docs/NNNN-short-name.md`:
...
- docs-site canonical pages must be updated for standard language/project reference changes.
- `docs/` operational files must be updated for task state, `User Task Inbox`, `Agent Task Queue`, checklist, traceability, or agent workflow changes.
...
- Run relevant verification and `git diff --check`. For docs-site changes, run `npm run build` in `docs-site`.
