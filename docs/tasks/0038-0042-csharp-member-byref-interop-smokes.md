...
Referenced `net48` C# local DLL APIs를 TypeSharp source에서 호출하고 generated `net48` C# project가 property, `params`, `out`, `in`, `ref` call shapes를 컴파일하는 smoke coverage를 묶는다.
...
- [0033-0037-generated-net48-build-pipeline.md](0033-0037-generated-net48-build-pipeline.md)
- `src/TypeSharp.Compiler`
- `tests/TypeSharp.Compiler.Tests`

## Completed Work

- `0038-csharp-property-access-smoke`: imported `LegacyFormatter.Prefix` property read compiles through generated `net48` project.
- `0039-csharp-params-interop-smoke`: imported `LegacyParams.Join(string, params string[])` positional call compiles through generated `net48` project.
...
- [x] local `net48` DLL exposes public property, `params`, `out`, `in`, and `ref` APIs used by smoke tests.
...
- [x] generated `net48` projects compile successfully.
...
Done:
- Generated C# compile smoke now covers imported C# property access, `params`, `out`, `in`, and `ref` call-site shapes from a referenced local `net48` DLL.
