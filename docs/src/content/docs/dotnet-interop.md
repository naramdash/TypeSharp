...
- indexers, including regular and checked/unchecked bounded integral/floating-point/decimal multiplicative compound assignment plus bounded null-conditional assignment/read, additive compound assignment, bounded integral/floating-point/decimal null-conditional multiplicative compound assignment, bitwise compound assignment, shift compound assignment, and logical unsigned shift assignment support for metadata-backed imported C# instance indexers; null-conditional indexer checked/unchecked multiplicative wrappers remain a later slice,
