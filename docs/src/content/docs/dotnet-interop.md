...
- indexers, including bounded null-conditional assignment/read, additive compound assignment, bitwise compound assignment, shift compound assignment, and logical unsigned shift assignment support for metadata-backed imported C# instance indexers,
