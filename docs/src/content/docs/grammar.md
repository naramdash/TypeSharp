...
An extension property declaration that would duplicate another TypeSharp-authored exact receiver/name pair or be hidden by the implemented ordinary or structural member steps reports `TS2201` during type checking.
