...
| --- | --- | --- | --- |
| `fun` | Public ABI slice | Static method on generated module/container; `params` and optional/default metadata for the supported suffix rules. | Generic function plus generated `net48` C# consumer smokes cover the current explicit, `params`, optional/default, and generic optional/default parameter subsets. Function overload ranking and broader higher-order inference remain backlog. |
