...
| `class` | Public ABI slice, MVP limited | Named CLR class with optional generic parameters/constraints, `partial`, an implicit public parameterless constructor, public instance `fun` methods, and typed instance/static `event` members backed by named delegate types. | Class API, generic type, generic constraint, partial declaration, instance/static event members, unsupported member diagnostic, and C# consumer smokes cover the 1.0 subset. TypeSharp-authored constructors, fields, properties, explicit inheritance/implementation clauses, static/abstract/virtual/override members other than static events, setters, indexers, operators, nested types, partial methods, and broader member-body analysis remain backlog. |
