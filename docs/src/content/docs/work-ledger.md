...
| Current tooling slice | Task `0268-realistic-runnable-tysh-examples` is complete and folded into the compressed task rollup. No active task is selected. |
