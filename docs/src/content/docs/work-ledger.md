...
| Current tooling slice | Task `0260-docs-dependency-update` is complete and folded into the compressed task rollup. No active task is selected. |
...
| Docs and adoption | Astro Starlight docs site, GitHub Pages workflow, pinned current docs package dependencies, runnable examples, migration guide, docs benchmarks, host compatibility notes, progress/ADR/regression policy, release readiness, and traceability. |
