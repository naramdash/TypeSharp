...
| Current tooling slice | Task `0267-csharp-docs-parity-detail` is complete and folded into the compressed task rollup. No active task is selected. |
