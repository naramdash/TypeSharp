...
| Current tooling slice | Task `0273-lambda-null-coalescing-overload-inference` is complete and folded into the compressed task rollup. No active task is selected. |
