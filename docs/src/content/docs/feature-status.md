...
| Bitwise compound assignment | MVP limited | `|=`, `&=`, and `^=` parse and lower over the current assignment surface to ordinary C# 7.3-compatible assignment operators. Shift assignment, user-defined operators, and broader assignment target analysis remain backlog. |
