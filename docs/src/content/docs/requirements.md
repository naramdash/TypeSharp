...
This page is the docs canonical requirements ledger. The former repository bridge file `docs/requirements.md` was removed after its durable content was folded here.
