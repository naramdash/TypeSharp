...
| Public ABI snapshot smoke | 통과 | `GeneratedNet48AssemblyPublicAbiSnapshotIsStable`가 generated `net48` DLL을 `TypeSharpMetadataReader`로 읽고 public `Module.describe(Customer): string`, `Customer.Name`, `Customer.Age`, `Customer.Equals`, `Customer.GetHashCode` metadata shape를 검증한다. |
