...
이 파일은 Codex `/goal`, Ralph mode, 장기 실행 에이전트가 이어받을 수 있는 작업 원장 입구다. 완료된 개별 task packet은 누적 보관하지 않고 rollup으로 압축한다.
...
| 완료 범위 | 0001-0255 |
| 압축 원장 | [0001-0255-task-ledger-rollup.md](0001-0255-task-ledger-rollup.md) |
...
1. 이 파일에서 활성 task가 있는지 확인한다.
2. 완료된 작업 이력은 [0001-0255-task-ledger-rollup.md](0001-0255-task-ledger-rollup.md)를 읽는다.
