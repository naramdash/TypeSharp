...
| Docs contract tests verified older benchmark pages only. | All benchmark sources | Update docs contract checks for new pages, sidebar entries, and headings. |

## Overhaul Plan Applied

The docs now follows a benchmark-derived structure:
