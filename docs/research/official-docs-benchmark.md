...
| Interop / platform | Moderate | Strong | Moderate | Strong | Strong | Add a dedicated .NET Framework and C# interop docs page. |
...
| Docs contract tests only checked the previous page set. | All benchmark sources use stable navigation groups | Updated docs contract checks for new pages and benchmark-derived anchors. |
| No durable benchmark record linked the official docs analysis to TypeSharp docs changes. | All sources | Added this benchmark report, now stored under `docs/research/`. |
