...
| Module graph, namespace, import/export, open declarations, ambient signatures | [grammar/modules.md](grammar/modules.md), [grammar/resolution.md](grammar/resolution.md) | parser fixtures, binder symbols, source module graph diagnostics, backend import/open/alias/namespace-import snapshots, root namespace fallback build smoke, multi-source module container build/run smokes, ambient parser fixture and build smoke |
