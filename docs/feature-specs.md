...
| Dynamic capability boundaries | [grammar/types.md](grammar/types.md), [grammar/interop.md](grammar/interop.md), [csharp-interop.md](csharp-interop.md), [diagnostics.md](diagnostics.md) | `TS2206`, `TS2207`, diagnostics fixtures, CLI smokes |
