...
| Module graph, namespace, import/export, open declarations, ambient signatures | [grammar/modules.md](grammar/modules.md), [grammar/resolution.md](grammar/resolution.md) | parser fixtures, binder symbols, backend import/open snapshots, root namespace fallback build smoke, ambient parser fixture and build smoke |
