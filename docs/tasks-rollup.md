...
End Time: 2026-05-20 22:42:36 +09:00
...
This rollup replaces individual completed task packet files for work 0001 through 0256. Future completed active packets should be folded into this file, then removed from `docs/`.
...
- Interop-focused docs-site pages: [.NET Interop](../docs-site/src/content/docs/dotnet-interop.md), [Diagnostics](../docs-site/src/content/docs/diagnostics.md)
...
- `vscode/typesharp`
- `examples/runnable`
- [CLI](../docs-site/src/content/docs/cli.md), [VS Code And LSP](../docs-site/src/content/docs/vscode-lsp.md)

## Documentation Process Release And Adoption

Completed docs/adoption work established:

- docs-site became the canonical standard language/project ledger surface.
- `docs/` was reduced to flat agent-work files only.
...
- Official docs benchmark artifacts moved to `docs-site/research`.
...
- [Modules And Imports](../docs-site/src/content/docs/modules.md), [Type System](../docs-site/src/content/docs/type-system.md)
...
- docs-site/documentation build smoke: docs-site package/config/content contract is covered by the C# runner and `npm run build` succeeds.
...
- Completed historical work through task 0256 is compressed here.
- `docs/tasks.md` is the active task pointer.
- `docs/tasks-rollup.md` is the only completed task rollup file.
